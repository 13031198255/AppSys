								...
								<select name="queryStatus" class="form-control">
									<c:if test="${statusList != null }">
									    ...
									    <c:forEach var="dataDictionary" items="${statusList}">
									   		<option <c:if test="${dataDictionary.valueId == queryAppInfoVO.queryStatus }">selected="selected"</c:if>
			    ...
			    <ul>
			    	<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input name="querySoftwareName" type="text" class="form-control col-md-7 col-xs-12" value="${queryAppInfoVO.querySoftwareName }">
							</div>
						</div>
					</li>
